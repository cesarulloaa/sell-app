...
export const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('🔵 1. Llamando signup...');
      const fullPhoneNumber = `${formData.countryCode}${formData.phoneNumber}`;
      console.log('   Datos:', { email: formData.email, businessName: formData.businessName });

      console.log('🔵 2. Esperando respuesta de signup...');
      await signup(
        formData.email,
        formData.password,
      ...
      console.log('✓ 2.1 Signup completado exitosamente!');
      console.log('🔵 3. Navegando a dashboard...');

      navigate('/dashboard');

      console.log('✓ 3.1 Navigate ejecutado');
